                ...
                <div class="container">
                    <div class="row">
                        ...
                        <input type="text" name="noCuenta"
                            class="form-control @error('noCuenta') is-invalid @enderror"
                            value="{{ old('noCuenta', $catalogocuenta?->noCuenta) }}" id="no_cuenta"
            ...
            <div class="col-md-12">
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <div class="form-group mb-2 mb20">
                        ...
                        <input type="text" name="CTADependiente"
                            class="form-control @error('CTADependiente') is-invalid @enderror"
                            value="{{ old('CTADependiente', $catalogocuenta?->CTADependiente) }}"
                    ...
                    <div class="form-group mb-2 mb20">
                        ...
                        <input type="text" name="movimientos"
                            class="form-control @error('movimientos') is-invalid @enderror"
                            value="{{ old('movimientos', $catalogocuenta?->movimientos) }}" id="movimientos"
